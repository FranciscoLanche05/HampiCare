-- =====================================================================
-- HampiCare - Script de Base de Datos (PostgreSQL - Supabase)
...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    rol            VARCHAR(30)   NOT NULL CHECK (rol IN ('ADMIN', 'CAJERO', 'REPORTES')),
...
CREATE TABLE IF NOT EXISTS configuracion (
    id                      SERIAL        PRIMARY KEY,
    nombre_empresa          VARCHAR(150)  NOT NULL DEFAULT 'HampiCare',
...
INSERT INTO configuracion (id, nombre_empresa, iva, umbral_stock_bajo, umbral_dias_vencimiento)
...
-- 20 Clientes
INSERT INTO clientes (nombres, apellidos, correo, cedula, telefono, sector) VALUES
...
INSERT INTO compras (proveedor_id, medicamento_id, cantidad, precio_compra) VALUES
    (2, 6, 97, 0.72),
    (4, 20, 18, 1.8),
    (4, 13, 86, 1.32),
    (4, 17, 42, 0.9),
